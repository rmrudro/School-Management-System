<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site.Master" AutoEventWireup="true"
    CodeBehind="StudentsAdd.aspx.cs" Inherits="EducationMgtSystem_Web.admin.StudentsAdd" %>
        ...
        <fieldset>
            ...
            <table width="100%" border="0" cellspacing="5" cellpadding="0">
                <tr>
                    ...
                    <td width="35%">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtFirstName"
                            ...
                            ErrorMessage="First Name can't left blank !!"></asp:RequiredFieldValidator>
                    </td>
                    <td width="15%">
                        <label>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtLastName"
                            SetFocusOnError="true" ForeColor="Red" ValidationGroup="signup" Display="Dynamic"
                            ErrorMessage="Last Name can't left blank !!"></asp:RequiredFieldValidator>
                    </td>
                    <td>
                        &nbsp;
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="drpSex" runat="server" CssClass="input_field" Width="50%">
        ...
        <fieldset>
            ...
            <table width="100%" border="0" cellspacing="5" cellpadding="0">
                <tr>
                    ...
                    <td width="35%">
                        <asp:DropDownList ID="drpClass" runat="server" CssClass="input_field" Width="50%">
                            <asp:ListItem>-- Select --</asp:ListItem>
